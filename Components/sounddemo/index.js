...
import soundsFile from '../../assets/soundsFile';
...
const sFile = [];
const sounds = () => {
    soundsFile.map((sound)=>{
        sFile.push(sound.sound);
    })
} 
...
const audioTests = [
  ...
  },
  {
    ...
    isRequire: true,
    url: require('../../assets/sounds/waves.mp3'),
    onPrepared: (sound, component) => {
      sound.setNumberOfLoops(-1);
      component.setState({loopingSound: sound});
    },
  },
  {
    ...
    isRequire: true,
    url: require('../../assets/sounds/rain-on-car.m4a'),
    onPrepared: (sound, component) => {
      sound.setNumberOfLoops(-1);
      component.setState({loopingSound: sound});
    },
